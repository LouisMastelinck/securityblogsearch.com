...
date: 2020-10-22
tags: [entra-id, conditional-access, microsoft-endpoint-manager, modern-workplace, security]
...
summary: "Governing when users receive authentication prompts when authenticating to Azure Active Directory (Azure AD) is depending on more than one setting, on which functionalities are in use and also in w..."
---
